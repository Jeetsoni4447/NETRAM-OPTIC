  ...
  return (
    <div className="min-h-screen w-full flex bg-gray-100 transition-all duration-300">
      ...
      <main className="flex-1 flex flex-col items-center py-4 max-md:mt-20">
        ...
        <h1 className="text-2xl font-bold mb-4 text-gray-800">Reading Glasses Collection</h1>

        {loading ? (
          <h4 className="text-gray-600 mt-10">Reading Glasses Collection Loading…</h4>
        ) : error ? (
